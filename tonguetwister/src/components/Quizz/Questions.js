...
export default function Questions() {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        { id: 0, text: " are waiting", isCorrect: true },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 1, text: "will call", isCorrect: true },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 2, text: "are eating", isCorrect: true },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 1, text: "am reading", isCorrect: true },
    ...
    <div>
      {showLevel ? (
        <div className="question-level">
          ...
          <button className="btn-level" onClick={() => setShowLevel(false)}>Beginner</button>
          <button className="btn-level" onClick={() => setShowLevel(false)}>Intermidiate</button>
          <button className="btn-level" onClick={() => setShowLevel(false)}>Advance</button>
        </div>
      ) : (
